...
function handleException(member, client) {
    ...
    getChannelObject("767797150725308466", getGuildObject("763358407666696202", client)).send(`<@${member.id}>`);
    getChannelObject("767797150725308466", getGuildObject("763358407666696202", client)).send(embedException);
}
